...
`PROMO_COUPON_ENABLED` should stay `false` in production unless you are running a short, controlled test. Polar license validation requires a License Keys benefit on each paid product and the matching benefit IDs above.
